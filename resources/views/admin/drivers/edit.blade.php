<x-app-layout title="Edit Supir — SIPETRANS">
    <div class="px-3 pt-3 pb-4" style="max-width:42rem;margin:0 auto;">
        ...
        <div class="d-flex align-items-center gap-2 mb-3">
            ...
            <h1 class="text-sm fw-bold text-slate-800 mb-0">Edit Supir — <span class="text-slate-500 fw-normal">{{ $driver->name }}</span></h1>
        </div>
