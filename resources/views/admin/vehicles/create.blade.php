<x-app-layout title="Tambah Kendaraan — SIPETRANS">
    <div class="px-3 pt-3 pb-4" style="max-width:42rem;margin:0 auto;">
        ...
        <div class="d-flex align-items-center gap-2 mb-3">
            ...
            <h1 class="text-sm fw-bold text-slate-800 mb-0">Tambah Kendaraan Baru</h1>
        </div>
            ...
            <form action="{{ route('admin.vehicles.store') }}" method="POST">
                ...
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-6">
                        ...
                        @error('type')<div class="invalid-feedback text-xxs">{{ $message }}</div>@enderror
                    </div>
                </div>
                <div class="row g-3 mb-2">
                    <div class="col-6">
                ...
                <div class="mb-2">
                    ...
                    <textarea name="notes" rows="2" placeholder="Catatan tambahan tentang kendaraan"
                              class="form-control form-control-sm">{{ old('notes') }}</textarea>
                </div>
