                                    ...
                                    <td class="px-3 py-2 text-center">
                                        <div class="d-flex align-items-center justify-content-center gap-1">
                                            <a href="{{ route('admin.recurring-templates.edit', $item) }}"
                                               class="d-inline-flex align-items-center justify-content-center rounded bg-amber-50 text-amber-600 border border-amber-200"
                                            ...
                                            <form action="{{ route('admin.recurring-templates.destroy', $item) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus template ini? Pengajuan yang sudah terbuat tidak akan terhapus.');">
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                        class="d-inline-flex align-items-center justify-content-center rounded bg-red-50 text-danger border border-red-200"
